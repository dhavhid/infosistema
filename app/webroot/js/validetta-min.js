...
;(function( $ ) {
    ...
    messages = {
        ...
        email     : 'La direcci&oacute;n de correo electr&oacute;nico no es v&aacute;lida.',
        number    : 'Este campo solo acepta n&uacute;meros.',
        maxLength : 'El m&aacute;ximo de caracteres permitidos es {count}',
        minLength : 'El m&iacute;nimo de caracteres permitidos es {count}',
        maxChecked  : 'El m&aacute;ximo de opciones permitidas es {count}.',
        minChecked  : 'Por favor seleccione por lo menos {count} opción.',
        maxSelected : 'El m&aacute;ximo de selecciones permitidas es {count}',
        minSelected : 'El m&iacute;nimo de selecciones permitidas es {count}',
        notEqual    : 'Los valores de los campos no coinciden.',
        creditCard  : 'N&uacute;mero de tarjeta de crédito no v&aacute;lido.'
    },
